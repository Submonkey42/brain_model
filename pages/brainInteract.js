...
function chImg() {
    ...
    if (brainSelect.value == "fl") {
        brainImage.src = "../images/Brain_1.png";
    ...
    if (brainSelect.value == "pl") {
        brainImage.src = "../images/Brain_2.png"        
    ...
    if (brainSelect.value == "ol") {
        brainImage.src = "../images/Brain_3.png";        
    ...
    if (brainSelect.value == "tl") {
        brainImage.src = "../images/Brain_4.png";        
    ...
    if (brainSelect.value == "cb") {
        brainImage.src = "../images/Brain_5.png";        
    ...
    if(brainSelect.value == "bs") {
        brainImage.src = "../images/Brain_6.png";        
